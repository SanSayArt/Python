...
Стихотворение  Винни-Пух передаст вам автоматически в переменную stroka в виде строки. В ответе напишите Парам пам-пам, если с ритмом все в порядке и Пам парам, если с ритмом 
все не в порядке.
...
stroka = 'пара-ра-рам'
words = ['у','е','ё','ы','а','о','э','я','и','ю']
lst_fraz = stroka.split()
if len(lst_fraz) > 1:
    lst = [sum(w in words for w in fraz) for fraz in lst_fraz]
    #print(lst)
    if len(set(lst)) == 1:
        print("Парам пам-пам")
    else:
